...
{
    private SerializedProperty playerMover;
    ...
    {
        playerMover = serializedObject.FindProperty("playerMover");
    ...
    {
        EditorGUILayout.PropertyField(playerMover, new GUIContent("Player Mover", "Drag PlayerMover."));
